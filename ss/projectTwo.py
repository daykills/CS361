...
gui.title("Car Photoshop Showcase")  #add the title of the window
gui.geometry("900x500") #resize the window
gui.configure(background = 'lightsteelblue') #set window background color


####### user input area#############

#create a user text input box
textEntry = tk.Entry(gui, bg = 'white', font = ("Monaco", 10))
textEntry.place(x = 13, y = 55, height = 70, width = 370)
#create a label of user text input box
textEntryLabel = tk.Label(gui, text = "User Input ", bg = "lightsteelblue", bd = 10, fg = "black", font = ("Monaco", 20)) 
textEntryLabel.place(x = 110, y = 3)
